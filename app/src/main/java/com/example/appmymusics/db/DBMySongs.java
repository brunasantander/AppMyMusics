package com.example.appmymusics.db;
...
public class DBMySongs extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("INSERT INTO musica VALUES (NULL, 2025, 'Titulo 1', 'Interprete 1', 1, 120)");
        db.execSQL("INSERT INTO musica VALUES (NULL, 2025, 'Titulo 2', 'Interprete 2', 1, 90)");
    }
